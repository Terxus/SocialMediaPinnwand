...
public class BeitragErstellen {
	...
	public void beitragAnzeigenVonAbo(final Beitrag beitrag, final Nutzer nutzer) {
		...
		service.likeZaehlen(beitrag, new AsyncCallback<Integer>() {
			...
			@Override
			public void onFailure(Throwable caught) {
				logger.severe("Fehler bei Likesz�hlung");
		...
		// DAVOR ERST �BERPR�FEN OB SCHON GELIKED IST VON DEM EINGELOGGTEN
		// NUTZER!
											...
											service.likeZaehlen(
													...
													new AsyncCallback<Integer>() {
														...
														public void onFailure(
																Throwable caught) {
															logger.severe("Fehler bei Likez�hlung");
	...
	public void beitragAnzeigen(final Beitrag beitrag, final Nutzer nutzer) {
		...
		// ClickHandler m�ssen f�r jedes Beitragobjekt gelten, darum m�ssen sie
		...
		loeschen.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				service.textBeitragLoeschen(beitrag, new AsyncCallback<Void>() {
					@Override
					public void onFailure(Throwable caught) {
						logger.severe("Fehler beim L�schen!");
					}
					...
					public void onSuccess(Void result) {
						...
						logger.severe("Beitrag erfolgreich gel�scht");
					}
				});
			}
		...
		bearbeiten.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				// Bearbeiteter Text Speichern und in Label zur�ckverwandeln
				// (*Magic*)
						...
						if (tAreak.getValue().isEmpty()) {
							...
							service.kommentarErstellen(kommentar,
									new AsyncCallback<Void>() {
										...
										@Override
										public void onFailure(Throwable caught) {
											logger.severe("Kommentar konnte nicht hinzugef�gt werden");
										...
										public void onSuccess(Void result) {
											service.likeZaehlen(
													...
													new AsyncCallback<Integer>() {
														...
														public void onFailure(
																Throwable caught) {
															logger.severe("Error beim z�hlen der Likes");
						...
						public void onClick(ClickEvent event) {
							...
							service.likeAnlegen(lke, beitrag,
									new AsyncCallback<Void>() {
										...
										@Override
										public void onFailure(Throwable caught) {
											logger.severe("Like konnte nicht hinzugef�gt werden");
										...
										public void onSuccess(Void result) {
											...
											service.likeZaehlen(
													...
													new AsyncCallback<Integer>() {
														...
														public void onFailure(
																Throwable caught) {
															logger.severe("Like konnte nicht gez�hlt werden");
									...
									service.kommentarLoeschen(k,
											new AsyncCallback<Void>() {
												...
												public void onSuccess(
													...
													NutzerLogin nl = new NutzerLogin();
													nl.refreshBeitraege();
													logger.severe("Kommentar gel�scht!");
												}
											});
