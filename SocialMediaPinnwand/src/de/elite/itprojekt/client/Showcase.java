...
public abstract class Showcase extends VerticalPanel {
  ...
  protected HTML createHeadline(String text) {
    ...
    content.setStylePrimaryName("Pinnwandproject-headline");
    return content;
  }
   ...
   * <code>.pinnwandproject-simpletext</code> referenzieren bzw. formatieren.
   * 
  ...
  protected void append(String text) {
    HTML content = new HTML(text);
    content.setStylePrimaryName("pinnwandproject-simpletext");
    this.add(content);
  }
