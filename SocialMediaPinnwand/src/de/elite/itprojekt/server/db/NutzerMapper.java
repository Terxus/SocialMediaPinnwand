...
public class NutzerMapper {
	...
	public Nutzer erstellen (Nutzer n){
		...
		try {
			...
			if (rs.next()) {
				/*
				 * n erhält den bisher maximalen, un um 1 inkremetierten
				 * Primärschlüssel.
				 */
			 ...
			 * Objekte üergeben werden, wäre die Anpassung des Nutzer-Objekts auch 
	 ...
	 * 
	 * @param n auf der DB zu löschende "objekt"
	 */
